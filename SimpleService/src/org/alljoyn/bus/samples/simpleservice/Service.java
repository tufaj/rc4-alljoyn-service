...
public class Service extends Activity {
   ...
   class BusHandler extends Handler {
         ...
         */
    	String name = "New Coffee Maker";
    	String new1 = name.replace(" ", "_");
        private final String SERVICE_NAME = "org.alljoyn.bus.samples.simple." + new1;
        ...
        public void handleMessage(Message msg) {
            ...
            case DISCONNECT: {
                ...
                Log.i("runs cancel advertisename", "runing cancel");
            	mBus.releaseName(SERVICE_NAME);
            	mBus.cancelAdvertiseName(SERVICE_NAME, (short)(SessionOpts.TRANSPORT_ANY + SessionOpts.TRANSPORT_WFD));
                Log.i("done", "done cancel");
